...
exports.createBPMNProcess = function(processId, bpmnFilePath, persistencyPath, doneLoading, doneSaving) {
    ...
    var bpmnProcess = _createBPMNProcess(processId, processDefinition, handler, persistency);
 ...
 */
exports._createBPMNProcess = _createBPMNProcess = function(id, processDefinition, eventHandler, persistency, parentProcess, parentToken, parentHistory) {
...
BPMNProcess.prototype._emitNextTokens = function(currentFlowObject, data, returningFromSubprocess) {
    ...
    if (currentFlowObject.isCallActivity) {
        currentFlowObject.emitTokens(self, data, _createBPMNProcess, returningFromSubprocess);
    } else {
