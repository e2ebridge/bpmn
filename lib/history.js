 ...
 * @constructor
 */
var HistoryEntry = exports.HistoryEntry = function(flowObjectName, begin, end) {
...
var BPMNProcessHistory = exports.BPMNProcessHistory = function(history) {
    ...
    if (history) {
        this.historyEntries = history.historyEntries.map(function(historyEntry) {
            var entry = new HistoryEntry(historyEntry.name, historyEntry.begin, historyEntry.end);
