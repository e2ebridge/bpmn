...
exports.createBPMNCallActivity = function(node, baseFileName, prefix2NamespaceMap, importNamespace2LocationMap) {
    ...
    var location = relativeLocation ? pathModule.join(pathModule.dirname(baseFileName), relativeLocation) : "";
 ...
 * @return {BPMNProcess}
 */
BPMNCallActivity.prototype.createCalledProcess = function(callActivityToken, currentProcess, createBPMNProcess, calledProcessDefinition) {
    var handler = this.getHandler(currentProcess);
    var processDefinition = calledProcessDefinition || bpmnDefinitionsModule.getBPMNProcessDefinition(this.location);
...
BPMNCallActivity.prototype.getHandler = function(currentProcess) {
    ...
    var handler = mockupHandler && typeof mockupHandler === "object" ?
                    mockupHandler : handlerModule.getHandlerFromFile(bpmnFilePath);
    return handler;
};
