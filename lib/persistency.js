...
/**
 * @param {BPMNProcess} processEngine
 * @param {Function(error, data)} done
 */
Persistency.prototype.persist = function(processEngine, done) {
    var db = this.db;
    var persistentData = {
        processInstanceId: processEngine.processInstanceId,
        data: processEngine.data,
        state: processEngine.state
    };
