...
exports.createBPMNProcess = function(processId, bpmnFilePath, persistencyPath, doneLoading, doneSaving) {
    ...
    var bpmnProcess = createOrGetBPMNProcess(processId, processDefinition, handler, persistency);
...
exports.createBPMNProcess4Testing = function(id, processDefinition, eventHandler, persistency, parentProcess, parentToken, parentHistory) {
