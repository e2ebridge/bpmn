...
BPMNProcess.prototype._registerActivityEndEvents = function() {
    ...
    self.on(ACTIVITY_END_EVENT, function(activityName, data) {
        ...
        var trx = self.currentTrx = self.transactionLogger.startTransaction(self.processDefinition.name, 'PSTATE', 'TRANSITION', null, activityName+'Done');
...
BPMNProcess.prototype._registerThrowIntermediateEvents = function() {
    ...
    self.on(INTERMEDIATE_CATCH_EVENT, function(eventName, data) {
        ...
        var trx = self.currentTrx = self.transactionLogger.startTransaction(self.processDefinition.name, 'PSTATE', 'TRANSITION', null, eventName);
