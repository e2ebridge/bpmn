...
exports.getFromCache = processCacheModule.get;
exports.findByValue = processCacheModule.findByValue;
...
BPMNProcess.prototype._putTokenAt = function(currentFlowObjectName, data) {
    ...
    this._emitEvent(TOKEN_ARRIVED_EVENT, currentFlowObjectName, data);
};
...
BPMNProcess.prototype._registerOnTokenArrivedEvent = function() {
    ...
    self.onTokenArrivedEvent(function(currentFlowObjectName, data) {
        ...
        this.logger.logTokenArrivedAt(currentFlowObject, data);
