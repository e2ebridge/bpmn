 ...
 */
function removeFromActiveProcessesCache(processId) {
    delete activeProcessesCache[processId];
}
 ...
 * @returns {BPMNProcess}
 */
function getFromActiveProcessesCache(processId) {
    return activeProcessesCache[processId];
}
exports.getFromActiveProcessesCache = getFromActiveProcessesCache;
...
BPMNProcess.prototype._emitNextTokens = function(currentFlowObject, data, returningFromCalledProcess) {
    ...
    if (currentFlowObject.isCallActivity) {
        ...
        currentFlowObject.emitTokens(self, data, removeFromActiveProcessesCache);
    } else {
