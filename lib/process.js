       ...
       if (currentFlowObject) {
           if (currentFlowObject.waitForTaskDoneEvent) {
               ...
               if (currentFlowObject.hasBoundaryEvents) {
                   this._registerBoundaryEvents(currentFlowObject);
               }
           } else {
...
BPMNProcess.prototype._registerTokenEvent = function() {
    var self = this;
    self.onTokenArrivedEvent(function(tokenPosition, data) {
...
BPMNProcess.prototype._callHandler = function(tokenPosition, data) {
    ...
    if (handler && typeof handler === 'function') {
        ...
        this.defaultEventHandler.call(this.processClient, tokenPosition, done);
    }
