 ...
 */
exports.findByActivity = processModule.findByState;
 ...
 * If validation error occur, an exception of type ErrorQueue is thrown.
...
exports.getBPMNDefinitions = function(bpmnFilePath, cache) {
    if (cache) {
        return bpmnDefinitionsModule.getCachedBPMNDefinitions(bpmnFilePath);
    } else {
        return bpmnDefinitionsModule.getBPMNDefinitions(bpmnFilePath);
    }
};
