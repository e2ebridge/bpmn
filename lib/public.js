...
exports.createProcess = function(processId, bpmnFilePath, persistencyOptions, callback) {
    var processDefinition, bpmnProcess, error;
    ...
    bpmnProcess = createProcess(processId, bpmnFilePath, processDefinition, persistencyOptions, function(err, bpmnProcess){
        if(!callback){
            return;
        }
    ...
    if(!callback){
        ...
        async.eachSeries(processDefinitions, function(processDefinition, done) {
            ...
            createProcess(processId, bpmnFilePath, processDefinition, persistencyOptions, function(err, bpmnProcess){
                ...
                try {
                    participants = processDefinition.getCollaboratingParticipants();
...
function createProcess(processId, bpmnFilePath, processDefinition, persistencyOptions, callback) {
    ...
    return bpmnProcesses.createOrGetBPMNProcess(processId, processDefinition, handler, persistency, callback);
}
