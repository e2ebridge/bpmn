 ...
 * @return {BPMNProcessClient}
 */
exports.createStandaloneProcessFromXML = function(bpmnXML, handler, callback) {
    var processDefinition, error;
 ...
 * @param {Function} callback
 */
exports.createStandaloneCollaboratingProcessesFromXML = function(bpmnXML, handler, callback) {
    var processes = {};
