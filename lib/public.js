...
var restModule = require('./rest.js');
 ...
 * @returns {*}
 */
exports.createServer = restModule.createServer;

/**
 * @param {Object} query The query is an object that is being matched to the data.
 * @returns {Array.<BPMNProcess>}
 */
exports.findByProperty = processModule.findByProperty;

/**
 * @param {String} activityName
 * @returns {Array.<BPMNProcessClient>}
 */
exports.findByState = processModule.findByState;

/**
 * @param {String} taskName
 * @returns {Array.<BPMNProcessClient>}
 */
exports.findByTask = processModule.findByState;

/**
 * @param {String} eventName
 * @returns {Array.<BPMNProcessClient>}
 */
exports.findByEvent = processModule.findByState;

/**
 * @param {String} processName
 * @returns {Array.<BPMNProcessClient>}
 */
exports.findByName = processModule.findByName;

/**
 * @param {String} processId
 * @returns {BPMNProcessClient}
 */
exports.getById = processModule.getById;

exports.clearCache = function() {
    processModule.clearCache();
    bpmnDefinitionsModule.clearCache();
};

exports.logLevels = loggerModule.logLevels;
...
exports.createProcess = function(processId, bpmnFilePath, persistencyOptions) {
    ...
    if (processDefinitions.length === 1) {
        ...
        throw new Error("The BPMN file '" + bpmnFilePath + "'. contains more than one process definition. Use 'createCollaboratingBPMNProcesses' instead of 'createBPMNProcess'");
    }
...
exports.getBPMNDefinitions = function(bpmnFilePath, cache) {
    ...
    if (cache) {
        bpmnDefinitions = bpmnDefinitionsModule.getCachedBPMNDefinitions(bpmnFilePath);
    } else {
        bpmnDefinitions = bpmnDefinitionsModule.getBPMNDefinitions(bpmnFilePath);
    }
